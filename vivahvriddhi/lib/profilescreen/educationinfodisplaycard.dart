...
class EducationOccupationInfoDisplayCard extends StatefulWidget {
  final AnimationController? animationController;
  final Animation<double>? animation;

  const EducationOccupationInfoDisplayCard({Key? key, this.animationController, this.animation})
      : super(key: key);

  @override
  State<EducationOccupationInfoDisplayCard> createState() => _EducationOccupationInfoDisplayCardState();
}

class _EducationOccupationInfoDisplayCardState extends State<EducationOccupationInfoDisplayCard> {
  String? Education='';
  String? EmployedIn='';
  String? Occupation='';
  String? AnnualIncome='';
