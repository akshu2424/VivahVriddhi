...
class PersonalContactInfoDisplayCard extends StatefulWidget {
  final AnimationController? animationController;
  final Animation<double>? animation;

  const PersonalContactInfoDisplayCard({Key? key, this.animationController, this.animation})
      : super(key: key);

  @override
  State<PersonalContactInfoDisplayCard> createState() => _PersonalContactInfoDisplayCardState();
}

class _PersonalContactInfoDisplayCardState extends State<PersonalContactInfoDisplayCard> {
  String? Gmail='';
  @override
  void initState() {
