...
class RegistrationScreen4Update extends StatefulWidget {
  static String routeName = "/registrationscreen4";
  @override
  _RegistrationScreen4UpdateState createState() => _RegistrationScreen4UpdateState();
}
class _RegistrationScreen4UpdateState extends State<RegistrationScreen4Update> {
  ...
  Future<void> initializeData() async {
    ...
    String physical=await ap.getPhysicalOfUser();
    String height=await ap.getHeightOfUser();

    setState(() {
      _physicalstatusselected=physical;
  ...
  void storeData() async {
    ...
    ap.saveUpdatedPhysicalDataToFirebase(
      context: context,
      physicalstatus: _physicalstatusselected.toString(),
      heightincm: _heightselected.toString(),
      onSuccess: () {
