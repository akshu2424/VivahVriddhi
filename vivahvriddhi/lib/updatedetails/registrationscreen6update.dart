...
class RegistrationScreen6Update extends StatefulWidget {
  static String routeName = "/registrationscreen6";
  @override
  _RegistrationScreen6UpdateState createState() => _RegistrationScreen6UpdateState();
}

class _RegistrationScreen6UpdateState extends State<RegistrationScreen6Update> {
  ...
  Future<void> initializeData() async {
    ...
    if (mounted) {
      setState(() {
        _familytypeselected = education;
        _fathersoccupationselected=employee;
        _motheroccupationselected= occupation;
        _totalfamilymembersselected = annualincome;
      });
    }
  }
  @override
              ...
              child: Container(
                ...
                child: ListView(
                  children: <Widget>[
                    ...
                    Center(
                        child:Text("Update Family Details",
                          style:TextStyle(
  ...
  void storeData() async {
    ...
    ap.saveUpdatedFamilyDetailsDataToFirebase(
      context: context,
      ...
      onSuccess: () {
        ...
        showSnackBar(context, "Details Upadated Sucessfully");
