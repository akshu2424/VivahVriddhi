...
class RegistrationScreen5Update extends StatefulWidget {
  static String routeName = "/registrationscreen5";
  @override
  _RegistrationScreen5UpdateState createState() => _RegistrationScreen5UpdateState();
}

class _RegistrationScreen5UpdateState extends State<RegistrationScreen5Update> {
  ...
  Future<void> initializeData() async {
    ...
    String employee=await ap.getEmployedinOfUser();
    String occupation=await ap.getOccupationOfUser();
    String annualincome=await ap.getAnnualIncomeOfUser();
    if (mounted) {
      setState(() {
        _educationdoneselected = education;
        _employedinselected=employee;
        _occupationselectd= occupation;
        _annualincomeselected = annualincome;
      });
    }
  }
  @override
              ...
              child: Container(
                ...
                child: ListView(
                  children: <Widget>[
                    ...
                    Center(
                        child:Text("Update Education and Occupation Details",
                          style:TextStyle(
  ...
  void storeData() async {
    ...
    ap.saveUpdatedEducationalAndOccupationDataToFirebase(
      context: context,
